...
namespace Backend.WebApi.Migrations
{
    ...
    [Migration("20231220092520_AddVolunteersRegionCodeField3")]
    partial class AddVolunteersRegionCodeField3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Domain.Entities.WorkEntities.VolunteersChampionshipsCompetences", b =>
                {
                    ...
                    b.HasOne("Backend.Domain.Entities.WorkEntities.Volunteers", "Volunteers")
                        .WithMany()
